...
profile_likwid_sleep () {
    ...
    sleep 200 &
    PID=$!
    taskset -c 127,126 efimon-pid-power-analyser --pid ${PID} -s 50  > results_sleep/power_$1.csv
    echo "---------End profiling $1----------"
    wait
}
...
time profile_likwid_sleep "copy"
time profile_likwid_sleep "copy_mem"
time profile_likwid_sleep "copy_mem_avx"
time profile_likwid_sleep "daxpy_mem_avx_fma"
time profile_likwid_sleep "stream_mem_avx_fma"
time profile_likwid_sleep "update_avx"
time profile_likwid_sleep "load_mem"
time profile_likwid_sleep "load_avx"
time profile_likwid_sleep "store_mem"
time profile_likwid_sleep "store_mem_avx"
time profile_likwid_sleep "peakflops_avx_fma"
