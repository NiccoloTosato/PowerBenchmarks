...
#OMP_NUM_THREADS=16 numactl --physcpubind=64-127  gemm_oblas.x 67000 67000 67000  &
#likwid-bench -t peakflops_avx_fma -W S0:256GB:8:1:1 -i 100  &
#PID=$!
#taskset -c 127,126 efimon-pid-power-analyser --pid ${PID} -s 50  > power_8.csv
#wait

OMP_NUM_THREADS=16 numactl --physcpubind=64-127  gemm_oblas.x 80000 80000 80000  &
